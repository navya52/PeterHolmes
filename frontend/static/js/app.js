...
function displayResults(result) {
    ...
    if (result.address.address) {
        addressDiv.innerHTML = `
            ...
            <p><strong>Validation:</strong> ${result.address.validation.valid ? '✓ Valid' : '✗ Invalid'}</p>
            <p><strong>Notes:</strong> ${result.address.validation.notes}</p>
            ${result.address.validation.image_path ? `
                <img src="/${result.address.validation.image_path}" alt="Address" class="address-image">
            ` : ''}
        `;
    } else {
